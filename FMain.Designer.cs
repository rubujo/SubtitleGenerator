namespace SubtitleGenerator
{
    partial class FMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            CBLanguages.Location = new Point(265, 41);
            ...
            CBModel.Items.AddRange(new object[] { "Tiny", "Tiny En", "Base", "Base En", "Small", "Small En", "Medium", "Medium En", "Large V1", "Large" });
            ...
            CBSamplingStrategies.Location = new Point(392, 41);
            ...
            // CBQuantization
            // 
            CBQuantization.DropDownStyle = ComboBoxStyle.DropDownList;
            CBQuantization.FormattingEnabled = true;
            CBQuantization.Items.AddRange(new object[] { "No Quantization", "Q4_0", "Q4_1", "Q4_2", "Q5_0", "Q5_1", "Q8_0" });
            CBQuantization.Location = new Point(138, 41);
            CBQuantization.Name = "CBQuantization";
            CBQuantization.Size = new Size(121, 23);
            CBQuantization.TabIndex = 3;
            // 
            // FMain
            // 
        ...
        private ComboBox CBQuantization;
    }
}